...
class BaseMAETrainer_BS8_ep1000_patch_128(BaseMAETrainer):
    ...
    def __init__(
        ...
        plan.configurations[configuration_name].patch_size = np.array([128, 128, 128])
...
class BaseMAETrainer_BS8_ep1000_patch_160(BaseMAETrainer):
    ...
    def __init__(
        ...
        plan.configurations[configuration_name].patch_size = np.array([160, 160, 160])
        super().__init__(plan, configuration_name, fold, pretrain_json, device)
...
class BaseMAETrainer_BS8_ep1000_patch_224(BaseMAETrainer):
    ...
    def __init__(
        ...
        plan.configurations[configuration_name].patch_size = np.array([224, 224, 224])
        super().__init__(plan, configuration_name, fold, pretrain_json, device)
